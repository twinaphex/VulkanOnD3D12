...
static void demo_prepare_buffers(struct demo *demo) {
    ...
    err = vkCreateSwapchainKHR(demo->device, &swapchain_ci, NULL,
                                     &demo->swapchain);
    assert(!err);
...
static void demo_cleanup(struct demo *demo) {
    ...
    /* if (demo->validate) {
        vkDestroyDebugReportCallback(demo->inst, demo->msg_callback, NULL);
    } */
...
static void demo_init_vk(struct demo *demo) {
    ...
    /* if (demo->validate) {
        ...
        dbgCreateInfo.flags =
            VK_DEBUG_REPORT_ERROR_BIT_EXT | VK_DEBUG_REPORT_WARNING_BIT_EXT;
        err = vkCreateDebugReportCallback(demo->inst, &dbgCreateInfo, NULL,
                                              &demo->msg_callback);
        switch (err) {
        case VK_SUCCESS:
            break;
